/****************************************************************************
** Meta object code from reading C++ file 'ipc_client.h'
**
...
#error "The header file 'ipc_client.h' doesn't include <QObject>."
...
const QMetaObject IpcClient::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_IpcClient.data,
      qt_meta_data_IpcClient,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
