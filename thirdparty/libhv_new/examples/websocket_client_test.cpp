...
#if 0
std::string regiser_msg = 
"{"
"\"msg_type\":	\"request\","
"\"msg_func\":	1,"
"\"content\":	{"
"\"address\":	\"广东省-珠海市-香洲区-深圳\","
"\"compinstalltime\":	\" \","
"\"depart_guuid\":	\"71292fa1438f403aa9a1126952d448e4\","
"\"disksn\":	\"WD-WCC2EMH47562\","
"\"user\":	\"罗克平\","
"\"ip\":	\"192.168.0.35\","
"\"unit_guid\":	\"737938f6ae4749948decf26dc909b934\","
"\"user_guid\":	\"a5b39630154252af5cadbabc94f59fd6\""
"}"
"}";
#endif
...
public:
    ...
    int connect(const char* url) {
        ...
        onmessage = [this](const std::string& msg) {
            printf("onmessage(type=%s len=%d): %.*s\n", opcode() == WS_OPCODE_TEXT ? "text" : "binary", (int)msg.size(), (int)msg.size(), msg.data());
        };
        onclose = []() { printf("onclose\n"); };
