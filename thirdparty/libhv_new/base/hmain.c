...
int main_ctx_init(int argc, char** argv) {
    ...
    get_current_user(g_main_ctx.current_user, sizeof(g_main_ctx.current_user));
    get_home_dir(g_main_ctx.home_dir, sizeof(g_main_ctx.home_dir));
